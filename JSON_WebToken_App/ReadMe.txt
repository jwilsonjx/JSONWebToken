...
Requirement: The credentials passed for basic authentication must be added to the QueryUsers method 
in the VirtualDatabase Model (this will be your device domain\login name). 
